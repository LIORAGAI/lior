#!/usr/bin/env python3
"""
מקודד קובץ אקסל: מצפין כל עמודה שכותרתה מכילה את המילה "תקודד" (עם או בלי מרכאות),
ומחליף את כל הערכים שמתחתיה בקודים אנונימיים. שומר קובץ מיפוי מקומי (mapping.json)
שאינו עולה לשום מקום - יש להשתמש בו מאוחר יותר עם restore.py כדי לשחזר את הנתונים
