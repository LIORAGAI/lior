...
זיהוי מתבצע אוטומטית לפי כותרות עמודות ולפי תוכן התא, וכן לפי סימון ידני - הוספת
המילה "תקודד" לכותרת העמודה. אין שאלות אינטראקטיביות - אם משהו לא זוהה אוטומטית,
יש להוסיף "תקודד" לכותרת ולהריץ שוב.
